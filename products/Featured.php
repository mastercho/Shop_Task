...
//$obj_product=$_REQUEST['category'];
$result_product = $obj_product->featured_products();
$item_per_page = 9;
...
$resultlimitproduct = $obj_product->featured_products_by_limit($s, $item_per_page);
?>
</head>
<body>
    ...
    <div class="container">
        ...
        <div class="col-sm-9" id="product_area">
            ...
            while ($row_product = $resultlimitproduct->fetch_array()) {
                if ($row_product["product_status"] == "Active" & $row_product['product_discount'] != 0) {
                    ?> 
                    
                    <div class="col-sm-4 col-lg-4 col-md-4">
                        <div class="thumbnail">
                            <span class="badge"><?php echo $row_product['product_discount'] ?> Discount</span>   
            ...
            <div class="col-md-12">
                <ul class="pagination">
                    ...
                    for ($page_counter = 1; $page_counter <= $total_pages; $page_counter++) {
                        echo '<li><a href="featured.php?s=' . $start_index . '">' . $page_counter . '</a></li>';

...
$result_product = $obj_product->new_products();
$item_per_page = 9;
...
$resultlimitproduct = $obj_product->new_products_by_limit($s, $item_per_page);
?>
</head>
<body>
    <!--logo Area-->
    ...
    <div class="container">
        ...
        <div class="col-sm-9" id="product_area">
            ...
            <div class="col-md-12" >
                <h2 class="page-header">New Products</h2>
            </div>
                    ...
                    <!--            <div class="col-md-4 col-md-6">
                                    <div class="panel panel-default text-center">
                                        ...
                                        <div class="panel-body">    
                                            ...
                                            <div class="panel-heading"><h4><?php echo $row_product["product_name"]; ?></h4></div> 
                                           
                                            <h4>$ <?php echo $row_product['product_price']; ?></h4>
                                    ...
                                    <div class="form-group">
                                        <form method="post" role="form" action="../process/process_cart.php?action=add">
                                            <input type="hidden" name="pid" value="<?php echo $row_product["product_ID"]; ?>">
                                            <input type="hidden" name="price" value="<?php echo $row_product["product_price"]; ?>">
                                        <input id="add_to_cart" class=" btn btn-primary" type="submit" value="Add to Cart">
                                        <a id="details" class="btn btn-default" href="details.php?product_ID=<?php echo $row_product['product_ID']; ?>" target="_blank">
                                                Details
                                        </a>
                                    </form>
                                    </div>
            ...
            <div class="col-md-12">
                <ul class="pagination">
                    ...
                    for ($page_counter = 1; $page_counter <= $total_pages; $page_counter++) {
                        echo '<li><a href="new_products.php?s=' . $start_index . '">' . $page_counter . '</a></li>';

...
$category = $_REQUEST['c'];
$result_c = $obj_product->get_products_by_category($category);
$item_per_page = 9;
$total_items = $result_c->num_rows;
...
$resultlimitproduct = $obj_product->product_category_by_limit($category, $s, $item_per_page);
?>
...
<body>
    ...
    <div class="container">
        ...
        <div class="col-sm-9" id="product_area">
            ...
            <div class="col-md-12" >
                <h2 class="page-header">Products by <?php echo $_REQUEST['c'] ?></h2>
            </div>
            <?php
            ...
            <div class="col-md-12">
                <ul class="pagination">
                    ...
                    for ($page_counter = 1; $page_counter <= $total_pages; $page_counter++) {
                        echo '<li><a href="product_category.php?c=' . $_REQUEST['c'] . '&s=' . $start_index . '">' . $page_counter . '</a></li>';

...
$brand = $_REQUEST['b'];
$result_b = $obj_product->get_products_by_brand($brand);
$item_per_page = 9;
$total_items = $result_b->num_rows;
...
$resultlimitproduct = $obj_product->product_brand_by_limit($brand, $s, $item_per_page);
?>
</head>
<body>
    ...
    <div class="container">
        ...
        <div class="col-sm-9" id="product_area">
            ...
            <div class="col-md-12" >
                <h2 class="page-header">Products by <?php echo $_REQUEST['b'] ?></h2>
            </div>
            <?php
            while ($row_product = $result_b->fetch_array()) {
                if ($row_product["product_status"] == "Active" & $row_product['product_brand'] == $_REQUEST['b']) {
                    ?> 
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    ...
                                    <h4 class="modal-title" id="myModalLabel"><?php echo $row_product['product_name']; ?></h4>
                                </div>
                                <div class="modal-body">
                                    <img  src="../images/products/<?php echo $row_product['product_name']; ?>/<?php echo $row_product['product_image']; ?>" alt=""> 
                                </div>
                                <div class="modal-footer">
                                    <p class="pull-left">
                                        <label class="control-label">Details : </label>
                                        <?php echo $row_product['product_info']; ?>
                                    </p>
                                </div>  
                            </div>
                        </div>
            ...
            <div class="col-md-12">
                <ul class="pagination">
                    ...
                    for ($page_counter = 1; $page_counter <= $total_pages; $page_counter++) {
                        echo '<li><a href="product_category.php?brand=' . $_REQUEST['b'] . '&s=' . $start_index . '">' . $page_counter . '</a></li>';

                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input type="text" class="form-control" id="product_name" name="product_name"
                                   value="<?php echo $row_product['product_name']; ?>" placeholder="Enter Product Name">
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input type="text" class="form-control" id="product_info" name="product_info"
                                   value="<?php echo $row_product['product_info']; ?>" placeholder="Enter Product info">
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input type="text" class="form-control" id="product_price" name="product_price"
                                   value="<?php echo $row_product['product_price']; ?>" placeholder="Enter Product Price">
                        </div>
